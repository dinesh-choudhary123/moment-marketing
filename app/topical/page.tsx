  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-[var(--foreground)]">Topical Marketing</h1>
        <p className="text-sm text-[var(--muted)] mt-2">Plan and execute topical campaigns aligned to trending news and conversations.</p>
